    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('brief', models.CharField(blank=True, max_length=200, null=True, verbose_name='商品描述')),
            ],
            options={
                'verbose_name': '商品分类管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='是否删除')),
                ('img_url', models.ImageField(upload_to='goods_gallery/%Y%m/%d', verbose_name='图片地址')),
            ],
            options={
                'verbose_name': '商品相册管理',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_on_sale', models.BooleanField(choices=[(0, '上架'), (1, '下架')], default=0, verbose_name='是否上架')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sp_goods.GoodsCategory', verbose_name='商品分类')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='goodssku',
            name='goods_spu',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sp_goods.GoodsSPU', verbose_name='商品spu ID'),
        ),
        migrations.AddField(
            model_name='goodssku',
            name='unit',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sp_goods.GoodsUnit', verbose_name='单位'),
        ),
    ]
