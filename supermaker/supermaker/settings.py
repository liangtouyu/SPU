"""
Django settings for supermaker project.
...
SECRET_KEY = 'ijc+^n1(9g*s7kx!+fcq_31uy)yhckkh*6v6b8r@$iyrz8h()t'
...
WSGI_APPLICATION = 'supermaker.wsgi.application'
